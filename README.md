...
<p align="center">
  <img src="https://kevingamez.vercel.app/api/github-card-light?username=kevingamez&amp;v=light1" alt="Kevin Gamez GitHub activity" width="900" />
</p>
...
|---------|-------------|-------|
| **[Portfolio Site](https://kevingamez.co)** | Personal site with Game of Life background and smooth animations | Astro · TypeScript · Preact · Zustand |
| **[Deep Learning in Agriculture](https://repositorio.uniandes.edu.co/entities/publication/2cd71d69-7078-4901-87e7-9bc9f2cb62e5)** | Oil-palm crop mapping in Colombia using Sentinel-1/2 imagery and DeepLab V3+ | Python · PyTorch · Google Earth Engine |
| **[AD ASTRA](https://github.com/favalosdev/AD_ASTRA2023-SpaceInvaders)** | Open-source aerial object detection for Amazon deforestation events | Python · OpenCV · YOLOv5 · FastAPI |
...
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:kevingamez.kg@gmail.com)
